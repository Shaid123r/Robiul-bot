...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("বস কাকে পছন্দ এমন 1 জনকে @ম্যানশন করুন", event.threadID);
...
setTimeout(() => {a({body: " যেদিন তুমি সবকিছু বুঝতে পারবে - সেদিন আমি অনিক থাকবো না! 🙂🌸 ŖÖBÏŮĻ ÏŚĻÄM🤝" + " " + name, mentions: arraytag})},23000);
